...
exports.McpTokenInputError = void 0;
exports.createMcpTokens = createMcpTokens;
/**
...
const bearer_js_1 = require("./bearer.js");
/** Invalid input to create()/list()/revoke(): map it to a 400, not a 500. */
class McpTokenInputError extends Error {
    field;
...
exports.McpTokenInputError = McpTokenInputError;
...
function createMcpTokens(config) {
    ...
    function generate() {
        const raw = tokenPrefix + (0, node_crypto_1.randomBytes)(RANDOM_BYTES).toString('base64url');
    ...
    async function verify(authorization) {
        const raw = (0, bearer_js_1.extractBearer)(authorization);
        if (!raw)
            return fail('MISSING');
